...
- (void)prepareUI {
    ...
    self.navigationView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, screenWidth, (K_IPhoneX ? 88 : 64))];
    [self.navigationView setBackgroundColor:[UIColor whiteColor]];
    [self.view addSubview:self.navigationView];
    
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, (K_IPhoneX ? 88 : 64) - 0.5, screenWidth, 0.5)];
    lineView.backgroundColor = [UIColor blackColor];
    [self.navigationView addSubview:lineView];
    
    UIButton *done = [UIButton buttonWithType:UIButtonTypeSystem];
    [done setTitle:@"Done" forState:UIControlStateNormal];
    [done setFrame:CGRectMake(5, ((44 - 30) * 0.5) + (K_IPhoneX ? 44 : 20), 50, 30)];
    ...
    [refresh setFrame:CGRectMake(screenWidth - 5 - 60, done.frame.origin.y, 60, 30)];
    ...
    UIView *titleView = [[UIView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(done.frame) + 5, (K_IPhoneX ? 44 : 20) + 5, refresh.frame.origin.x - 10 - CGRectGetMaxX(done.frame) , 44 - 10)];
    ...
    WKWebView *webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, (K_IPhoneX ? 88 : 64), screenWidth, screenHeight - (K_IPhoneX ? 88 : 64))];
    ...
    [progressView setFrame:CGRectMake(0, (K_IPhoneX ? 88 : 64), screenWidth, progressView.frame.size.height)];
